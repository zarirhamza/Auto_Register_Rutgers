...
/*
1. Input sectionnumber, sectionindexnumbers, netid, password, and classID as show below.
2. Run with "node autoRegister_v2.js"
*/
...
const classID = '01:198:344' // enter course ID in form xx:xxx:xxx here
	...
	var bodyHTML = null;
      ...
      do {
        try {
          ...
          await schedulePage.reload({waitUntil: 'networkidle0'});
        }
